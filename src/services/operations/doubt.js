...
export const getDoubts = async (page, limit = 7, search = "") => {
   let result = [];
   try {
      const response = await apiConnector("GET", `${doubtPoints.GET_ALL_DOUBT_API}?page=${page}&limit=${limit}&search=${search}`);
